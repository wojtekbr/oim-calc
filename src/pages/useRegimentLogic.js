...
export const useRegimentLogic = ({
    ...
    const handleImprovementToggle = (positionKey, unitId, impId) => {
        ...
        // Tutaj usuwamy stary alert, bo UI (RegimentEditor) już obsługuje 'disabled'.
        // Ale zachowujemy logikę aktualizacji stanu.
    ...
    const saveAndGoBack = () => {
        ...
        for (const impId of usedImprovements) {
            ...
            if (regImpDef?.max_amount) {
                // Obliczamy ile FAKTYCZNIE (płatnie) zużyto, uwzględniając darmowe
        ...
        // 3. Walidacja Wsparcia (stary kod)
